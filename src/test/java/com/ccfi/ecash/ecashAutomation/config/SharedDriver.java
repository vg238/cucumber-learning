 ...
 * </p>
 * <p>
 * A new instance of SharedDriver is created for each Scenario and passed to your Stepdef classes via Dependency Injection
 * </p>
 * <p>
...
public class SharedDriver extends EventFiringWebDriver {
    ...
    private static final Thread CLOSE_THREAD = new Thread() {
        @Override
        public void run() {
          REAL_DRIVER.quit(); //uncomment when you want to close browser
        }
    };
