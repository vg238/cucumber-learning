...
@CucumberOptions(strict = true, 
		...
		plugin = {"json:C:/devl/workspace/VijayGanji/ecashAutomation/target/cucumber-parallel/1.json",
				"html:C:/devl/workspace/VijayGanji/ecashAutomation/target/cucumber-parallel/1" }, 
		monochrome = false, 
		tags = {"@run", "~@ignored" }, 
